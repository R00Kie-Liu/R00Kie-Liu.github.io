...
2. [第2章：Roofline]({% post_url 2026-05-07-scaling-infra-ch02 %})
3. [第8章：训练并行]({% post_url 2026-05-07-scaling-infra-ch08 %})
4. [第10章：推理基础]({% post_url 2026-05-07-scaling-infra-ch10 %})
5. [第11章：推理优化]({% post_url 2026-05-07-scaling-infra-ch11 %})
